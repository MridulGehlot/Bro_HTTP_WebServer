...
int r;
bool success;
c.get("cart",&r,&success);
if(success) cout<<"value against cart - "<<r<<endl;
else cout<<"cart does not exist"<<endl;
*/
...
if(success) cout<<"value against salary - "<<r<<endl;
else cout<<"salary does not exist"<<endl;
