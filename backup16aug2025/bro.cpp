...
{
HttpStatusUtility::sendBadRequestError(clientSocketDescriptor);
closesocket(clientSocketDescriptor);
continue;
}
requestBuffer[i]='\0';
...
{
HttpStatusUtility::sendHttpVersionNotSupportedError(clientSocketDescriptor,httpVersion);
closesocket(clientSocketDescriptor);
continue;
}
...
{
HttpStatusUtility::sendNotFoundError(clientSocketDescriptor,requestURI);
closesocket(clientSocketDescriptor);
continue;
}
...
{
HttpStatusUtility::sendMethodNotAllowedError(clientSocketDescriptor,methodType,requestURI);
closesocket(clientSocketDescriptor);
continue;
}
